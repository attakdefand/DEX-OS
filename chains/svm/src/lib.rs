...
impl SVMChainAdapter {
    ...
    pub fn send_transaction(
        ...
        let tx_signature =
            "5Sd1ZKfE2R1hWsLn8X7xQ5C2D3E4F5G6H7I8J9K0L1M2N3O4P5Q6R7S8T9U0V1W2X3Y4Z5".to_string();
    ...
    fn validate_transaction(&self, tx: &SVMTransaction) -> Result<(), SVMError> {
        ...
        if tx.gas_limit > self.config.gas_limit {
            return Err(SVMError::TransactionError(format!(
        ...
        if tx.amount > 0 && self.is_known_scam_address(&tx.to) {
            ...
            return Err(SVMError::SecurityError(
